...
black = (0,0,0)
white=(255,255,255)
# coordinates where to put x and o on the window
x_pos1 = width/3+30
x_pos2 = width/3*2+30
y_pos1 = height/3+30
...
#loading images
starting = pg.image.load('tic tac opening.png')
...
def starts():
    ...
    text = font.render('Wait until make his move X', True, black, white)
...
def game_over(x):
    ...
    if x == 1:
        ...
        text = font.render('Tie', True, black, white)
        center = ( width/ 2 - 50,  height/ 2-10)
        win.fill(white)
        win.blit(text, center)
        pg.display.update()
